...
if (strpos($_SERVER['REQUEST_URI'], 'criarPerfil-4.php') !== false) {
    $sql = "UPDATE tbusuarios SET statusCadastro = 4 WHERE idUsuario = $idUsuario";
...
<body>
    ...
    <div class="principal" style="width: 100%;">
        ...
        <div class="hashtags" style="display: flex; flex-direction: row; flex-wrap: wrap;">
                ...
                while ($dados = mysqli_fetch_assoc($result)) {
                    echo
                    "<p style='margin-right: 10px; border: 1px solid black; padding-left: 10px; padding-right: 10px; padding-top: 3px; padding-bottom: 3px; border-radius: 150px; display: flex;'>#" . htmlspecialchars($dados["tituloHashtag"]) ."</p>
                    ";
                }
                ?>
            </div>
    ...
    <div class="inferior">
        <a href="concluirPerfil.php">Finalizar</a>
    </div>
